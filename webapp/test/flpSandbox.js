		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zacademycrudoperator-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zacademycrudoperator-display": {
								"semanticObject": "zacademycrudoperator",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zacademy.crudoperator",
									"url": sap.ui.require.toUrl("zacademy/crudoperator")
								}
							}
						}
					}
